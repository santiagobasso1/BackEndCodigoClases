...
const main = async () => {
    await mongoose.connect("mongodb+srv://santiagobasso:coderhouse@cluster0.fzskdnk.mongodb.net/?retryWrites=true&w=majority")
    const resultados1 = await orderModel.paginate({}, { limit: 2, page: 3 })
